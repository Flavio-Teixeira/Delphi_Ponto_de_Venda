...
type
  TPosicaoAtualEstoque00 = class(TForm)
    Panel1: TPanel;
    GroupBox1: TGroupBox;
    Label1: TLabel;
    BT_Buscar: TBitBtn;
...
var
  PosicaoAtualEstoque00: TPosicaoAtualEstoque00;

implementation

uses Conexao_BD, Rotinas_Gerais, Posicao_Atual_Estoque_01, Principal_00;

{$R *.dfm}

procedure TPosicaoAtualEstoque00.FormKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #27 Then
        Begin
        PosicaoAtualEstoque00.Close;
     End;
end;

procedure TPosicaoAtualEstoque00.FormShow(Sender: TObject);
begin
    Ampulheta();
    ...
    If Trim(EditBusca.Text) = '' Then
      Begin
        ...
        Else If Trim(ComboLocalBusca.Text)= 'Valor Negativo' Then

          Begin
          ConexaoBD.SQL_Produtos.SQL.Add('Select * from Produtos where Produto_Estoque_Atual < 0 Order By Produto_Descricao');
          End
...
procedure TPosicaoAtualEstoque00.BT_SairClick(Sender: TObject);
begin
     PosicaoAtualEstoque00.Close;
end;

procedure TPosicaoAtualEstoque00.BT_BuscarClick(Sender: TObject);
begin
    ConexaoBD.SQL_Produtos.Close;
    ConexaoBD.SQL_Produtos.SQL.Clear;
    If Trim(EditBusca.Text) = '' Then
...
procedure TPosicaoAtualEstoque00.ComboLocalBuscaKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #27 Then
        Begin
...
procedure TPosicaoAtualEstoque00.EditBuscaKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #27 Then
        Begin
...
procedure TPosicaoAtualEstoque00.BT_ImprimirClick(Sender: TObject);
begin
     Application.CreateForm(TPosicaoAtualEstoque01,PosicaoAtualEstoque01);
     PosicaoAtualEstoque01.QR_Posicao_Estoque.PreviewModal;
     PosicaoAtualEstoque01.QR_Posicao_Estoque.Destroy;
     PosicaoAtualEstoque01.Destroy;
end;
