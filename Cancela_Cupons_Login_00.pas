...
type
  TCancela_Cupons_Login00 = class(TForm)
    Panel1: TPanel;
    GroupBox1: TGroupBox;
    Label2: TLabel;
    Label1: TLabel;
...
var
  Cancela_Cupons_Login00: TCancela_Cupons_Login00;
  Contador  : Integer;

implementation

uses Conexao_BD, Rotinas_Gerais, Cancela_Cupons_00;

{$R *.dfm}

Procedure TCancela_Cupons_Login00.Verifica_Senha();
Var
   ValorSenha : String;
   Fiscal     : String;
...
Begin
     ...
     Else
        ...
        If Trim(Tipo_Cancelamento.Text)= 'F6' Then
          Begin
            Application.CreateForm(TCancela_Cupons00,Cancela_Cupons00);
            Cancela_Cupons_Login00.Visible:= False;
            Cancela_Cupons00.ShowModal;
            Cancela_Cupons00.Destroy;
          End
        Else
          Begin
            Cancela_Cupons_Login00.Visible:= False;
...
procedure TCancela_Cupons_Login00.Login_NomeKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #27 Then
        Begin
...
procedure TCancela_Cupons_Login00.Login_SenhaKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #27 Then
        Begin
...
procedure TCancela_Cupons_Login00.Login_OKClick(Sender: TObject);
begin
    Verifica_Senha();
end;

procedure TCancela_Cupons_Login00.FormKeyPress(Sender: TObject;
  var Key: Char);
begin
     If Key = #27 Then
        Begin
